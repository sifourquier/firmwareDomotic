...
void SSP0Init( void )
{
  ...
  /* Set DSS data to 8-bit, Frame format SPI, CPOL = 0, CPHA = 0, and SCR is 255 */
  LPC_SSP0->CR0 = (0xFF<<8)|0b0<<6|5;

  /* SSPCPSR clock prescale register bit 0 need =0*/
  LPC_SSP0->CPSR = 100; //100->~1kHz
