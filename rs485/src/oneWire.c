...
static volatile int pos_data=0;
static volatile int lentgh_write=0;
static volatile int lentgh_read=0;

static t_state1wire state_1W=S1W_END;
static t_stateDHT22 state_DHT=S1H_END;

static volatile uint64_t dataDHT22;
static volatile int posDataDHT22;
static volatile int timeDHT22;
...
void TIMER16_0_IRQHandler(void)
{
	...
	else if(mode==S1WM_DHT22)
	{
		...
		case S1H_ACK1:
			...
			GPIO_PORT_DTH22->IE |= (0x1<<BIT_DTH22);
			dataDHT22=0;
			state_DHT=S1H_READ;
			break;
		case S1H_READ:
