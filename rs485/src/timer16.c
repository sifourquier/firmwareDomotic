...
**
******************************************************************************/
void init_timer16(uint8_t timer_num, uint16_t TimerInterval/*us*/)
{
  if ( timer_num == 0 )
  {
...
//    LPC_IOCON->PIO0_9           |= 0x02;		/* Timer0_16 MAT1 */
    ...
    LPC_TMR16B0->PR  = 0; /* set prescaler to get 1 M counts/sec */
    LPC_TMR16B0->MR0 = TimerInterval*MHZ_PRESCALE-1; /* Set up 10 mS interval */
#if TIMER_MATCH
...
//    LPC_IOCON->PIO1_10          |= 0x02;		/* Timer1_16 MAT1 */
    ...
    LPC_TMR16B1->PR  = MHZ_PRESCALE-1; /* set prescaler to get 1 M counts/sec */
    LPC_TMR16B1->MR0 = TimerInterval-1; /* Set up 10 mS interval */
#if TIMER_MATCH
...
#endif
    LPC_TMR16B1->MCR = 1;				/* Interrupt on MR0 */
