...
void i2cWriteRead(uint8_t address, uint8_t* write, uint8_t lengthWrite, uint8_t* read, uint8_t lengthRead)
{
	int l;
	I2CWriteLength = lengthWrite+1;
	I2CReadLength = lengthRead;
	I2CWriteBuffer[0] = address;
	for(l=0;l<lengthWrite;l++)
		I2CWriteBuffer[l+1] = write[l];		/* address */
	I2CWriteBuffer[l+1]=address|1;
	I2CEngine();
	for(int l=0;l<lengthRead;l++)
		read[l]=I2CReadBuffer[l];		/* address */
}
