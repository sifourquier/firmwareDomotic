...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -DDEBUG -DLCD_CHEAP_2_TEMP_5_PLUS_2_DAY_4_HOME_IN_OUT_SUN_MOON_SNOW_LOCK_HAND_TIME -DBOARD_THERMOSTAT -DSHT30 -Dn_DHT22 -DLED_12V -Dn_TRIACK -Dn_DS18B20 -Dn_TLI4970 -DTHERMOSTAT_LCD -Dn_LED_SWITCH -DCR_INTEGER_PRINTF -D__CODE_RED -DCORE_M0 -D__LPC11XX__ -D__REDLIB__ -I"/home/simon/Sync/Domotic/rs485/firmware/rs485/inc" -Og -fno-common -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m0 -mthumb -D__REDLIB__ -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
