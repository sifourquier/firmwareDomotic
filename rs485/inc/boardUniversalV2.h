...
#define PORT_nCS_LCD PORT_MISO
#define BIT_nCS_LCD BIT_MISO

#define PWM_BACKLIGHT 2

#ifdef THERMOSTAT_LCD
#define NB_SW 5
#define LIST_PORT_SW PORT_SW1,PORT_SW2,PORT_SW3,PORT_SW4,PORT_SW5
#define LIST_BIT_SW BIT_SW1,BIT_SW2,BIT_SW3,BIT_SW4,BIT_SW5
#else
#define NB_SW 4
...
#define initBoard()\
		...
		LPC_IOCON->PIO0_2=PULLUP|DIGITAL;/*sw5*/\
